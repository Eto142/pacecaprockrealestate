                ...
                <div class="card-body">
                  ...
                  <form method="post" action="{{url('/send-user-email')}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="email" value="{{$userProfile->email}}" id="exampleInputEmail3" placeholder="Email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" class="form-control" id="exampleTextarea1" rows="4" name="message"></textarea>
                    </div>
