      ...
      <div class="col-md-6">
        ...
        <div id="productImageGallery" class="carousel slide" data-bs-ride="carousel">
          ...
          <ol class="carousel-indicators">
            <li data-bs-target="#productImageGallery" data-bs-slide-to="0" class="active"></li>
            <li data-bs-target="#productImageGallery" data-bs-slide-to="1"></li>
            <li data-bs-target="#productImageGallery" data-bs-slide-to="2"></li>
          </ol>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="{{asset($house->houseImages[3]->image)}}" alt="Product Image 1" class="img-fluid">
            </div>
            <div class="carousel-item">
              <img src="{{asset($house->houseImages[1]->image)}}" alt="Product Image 2" class="img-fluid">
            </div>
            <div class="carousel-item">
              <img src="{{asset($house->houseImages[2]->image)}}" alt="Product Image 3" class="img-fluid">
            </div>
          </div>
