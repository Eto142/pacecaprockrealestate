...
<div class="main-panel bg-light">
            <div class="content bg-light">
                ...
                @if (session('status'))
                   ...
                   @endif
                    <div class="mt-2 mb-4">
                        <h1 class="title1 text-dark">WE PROVIDE HEDGE FUND IN STOCKS</h1>
                    </div>

                                           <div class="col-lg-8 offset-lg-2 card bg-light shadow-lg p-lg-3 p-sm-5">
                        <h2 class="text-dark">Understanding Stocks</h2> <br>
                        <img src="{{asset('user/image/stock.jpg')}}" height="100px" width="" align="right" style="padding:5px;">
                            <div class="well">
...
Some of our Trading Instruments: BTC, ETH, BNB, CAD, XRP, NEX, XDC, XRM, Apple (AAPL), Tesla (TSLA), Amazon (AMZN), AMD (AMD), Facebook (FB), Netflix (NFLX), #CSCO, #GOOG, #ALP
                    ...
                    <div class="col-lg-4 p-4 card bg-light shadow-lg">
                            <div class="pricing-table purple border bg-light shadow-lg">
                                ...
                                <h2 style="color: blue;">SD STOCKS - CUXX1</h2>
                                <!-- Price -->
                                <h4 style="color: blueviolet;">Pays 0.99% daily</h4>
                                <!-- Features -->
                                <div class="pricing-features">
                                    <div  class="featured text-dark">Minimum  Deposit:<span class="text-dark">$50.00</span></div>
                                    <div class="featured text-dark">Maximum  Deposit:<span  class="text-dark">$15,000.00</span></div>
                                </div> <br>
                                <!-- Button -->
                                <div class="">
                                <form action="{{url('/buy-plan')}}" method="post">
                                        @csrf
                                    <input type="hidden" value="SD STOCKS - CUXX1" name="plan_name" >
                                    <input type="hidden" value="0.0099" name="plan_percent">
                                     <input type="hidden" value="0.99%" name="plan_percentage">
                                    <h5 class="text-dark">Amount to invest:</h5>
                                    <input type="number" min="50" max="15000" name="amount" placeholder="Amount" class="form-control text-dark bg-light" required id="field1"> <br>
                                          <select class="form-control text-dark bg-light" id="field2" name="plan_duration"  style="display: none;" required>
                                                        <option value="none" selected>Select Duration of your stocks investment</option>
                    ...
                    <div class="col-lg-4 p-4 card bg-light shadow-lg">
                            <div class="pricing-table purple border bg-light shadow-lg">
                                ...
                                <h2 style="color: blue;">SD STOCKS - CUXX2</h2>
                                <!-- Price -->
                                <h4 style="color: blueviolet;">Pays 1.3% daily</h4>
                                <!-- Features -->
                                <div class="pricing-features">
                                    <div  class="featured text-dark">Minimum  Deposit:<span class="text-dark">$20,000.00</span></div>
                                    <div class="featured text-dark">Maximum  Deposit:<span  class="text-dark">$200,000.00</span></div>
                                </div> <br>
                                <!-- Button -->
                                <div class="">
                                <form action="{{url('/buy-plan')}}" method="post">
                                        @csrf
                                    <input type="hidden" value="SD STOCKS - CUXX2" name="plan_name" >
                                    <input type="hidden" value="0.013" name="plan_percent">
                                     <input type="hidden" value="1.3%" name="plan_percentage">
                                        <h5 class="text-dark">Amount to invest:</h5>
                                    <input type="number" min="20000" max="200000" name="amount" placeholder="Amount" class="form-control text-dark bg-light" required id="field3"> <br>
                ...
                <div class="col-lg-4 p-4 card bg-light shadow-lg">
                            <div class="pricing-table purple border bg-light shadow-lg">
                                ...
                                <h2 style="color: blue;">SD STOCKS - CUXX3</h2>
                                <!-- Price -->
                                <h4 style="color: blueviolet;">Pays 2.5% daily</h4>
                                <!-- Features -->
                                <div class="pricing-features">
                                    <div  class="featured text-dark">Minimum  Deposit:<span class="text-dark">$500,000.00</span></div>
                                    <div class="featured text-dark">Maximum  Deposit:<span  class="text-dark">$5000,000.00</span></div>
                                </div> <br>
                                <!-- Button -->
                                <div class="">
                                <form action="{{url('/buy-plan')}}" method="post">
                                        @csrf
                                    <input type="hidden" value="SD STOCKS - CUXX3" name="plan_name" >
                                    <input type="hidden" value="0.025" name="plan_percent">
                                     <input type="hidden" value="2.5%" name="plan_percentage">
                                        <h5 class="text-dark">Amount to invest:</h5>
                                    <input type="number" min="500000" max="5000000" name="amount" placeholder="Amount" class="form-control text-dark bg-light" required id="field5"> <br>
