...
<head>
    ...
    <title>Cap Rock Real Estate</title>
                            ...
                            <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                                <tr>
                                    <td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        <!-- section text ======-->
                                        <h2>Welcome to Cap Rock Real Estate LLC</h2>
                                        <br>
                                        <br>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                        Thanks for joining Cap Rock Real Estate LLC as your new home. We're excited to have you on board!
                                        </p>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                          Account Details:
                                        </p>
                                        <br>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                        Your email is: {{$use['email']}}
                                        </p>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                        Your password is: {{$use['password']}}
                                        </p>
                                        <br/> 
                                        <p style='line-height: 24px'>
                                            Kind Regards,</br>
                                            Cap Rock Real Estate
                                        </p>
